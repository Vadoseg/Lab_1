...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Lab_1.srcs/sources_1/new/sv_led.sv"]"\
 ...
 "[file normalize "$origin_dir/Lab_1.srcs/sim_1/new/tb_sv_led.sv"]"\
  ]
  foreach ifile $files {
...
set_property -name "top" -value "tb_sv_led" -objects $obj
